...
void CTreeGenerator::loadFromXML( io::IXMLReader* xml )
{
    ...
    while ( xml->read() )
    {
        ...
        case io::EXN_ELEMENT:
            ...
            else if ( nodeName == L"child" && currentBranch != 0 && currentChild == 0 && currentLeaf == 0 )
            {
            ...
            else if ( nodeName == L"leaf" && currentBranch != 0 && currentChild == 0 && currentLeaf == 0 )
            {
            ...
            else if ( nodeName == L"length" && currentBranch != 0 && currentChild == 0 && currentLeaf == 0 )
            {
                currentBranch->Length = getValueRangeFloatFromXML( xml );
            }
            else if ( nodeName == L"radius" && currentBranch != 0 && currentChild == 0 && currentLeaf == 0 )
            {
                currentBranch->Radius = getValueRangeFloatFromXML( xml );
            }
            else if ( nodeName == L"radiusEnd" && currentBranch != 0 && currentChild == 0 && currentLeaf == 0 )
            {
                currentBranch->RadiusEnd = getValueRangeFloatFromXML( xml );
            }
            else if ( nodeName == L"lengthScale" && currentBranch != 0 && currentChild != 0 && currentLeaf == 0 )
            {
                currentChild->LengthScale = getValueRangeFloatFromXML( xml );
            }
            else if ( nodeName == L"radiusScale" && currentBranch != 0 && currentChild != 0 && currentLeaf == 0 )
            {
                currentChild->RadiusScale = getValueRangeFloatFromXML( xml );
            }
            else if ( nodeName == L"relativeLevel" && currentBranch != 0 && currentChild != 0 && currentLeaf == 0 )
            {
                currentChild->RelativeLevel = getValueRangeIntFromXML( xml );
            }
            else if ( nodeName == L"levelRange" && currentBranch != 0 && currentChild != 0 && currentLeaf == 0 )
            {
                currentChild->LevelRange = getValueRangeIntFromXML( xml );
            }
            else if ( nodeName == L"position" && currentBranch != 0 && currentChild != 0 && currentLeaf == 0 )
            {
                currentChild->Position = getValueRangeFloatFromXML( xml );
            }
            else if ( nodeName == L"orientation" && currentBranch != 0 && currentChild != 0 && currentLeaf == 0 )
            {
                currentChild->Orientation = getValueRangeFloatFromXML( xml );
            }
            else if ( nodeName == L"pitch" && currentBranch != 0 && currentChild != 0 && currentLeaf == 0 )
            {
                currentChild->Pitch = getValueRangeFloatFromXML( xml );
            }
            else if ( nodeName == L"gravity" && currentBranch != 0 && currentChild != 0 && currentLeaf == 0 )
            {
                currentChild->GravityInfluence = getValueRangeFloatFromXML( xml );
            }
            else if ( nodeName == L"count" && currentBranch != 0 && currentChild != 0 && currentLeaf == 0 )
            {
                currentChild->Count = getValueRangeIntFromXML( xml );
            }
            else if ( nodeName == L"root" && currentBranch == 0 && currentChild == 0 && currentLeaf == 0 )
            {
            ...
            else if ( nodeName == L"roll" && currentBranch != 0 && currentChild == 0 && currentLeaf != 0 )
            {
                currentLeaf->Roll = getValueRangeFloatFromXML( xml );
            }
            else if ( nodeName == L"axis" && currentBranch != 0 && currentChild == 0 && currentLeaf != 0 )
            {
            ...
            else if ( nodeName == L"anchor" && currentBranch != 0 && currentChild == 0 && currentLeaf != 0 )
            {
            ...
            else if ( nodeName == L"width" && currentBranch != 0 && currentChild == 0 && currentLeaf != 0 )
            {
                currentLeaf->Width = getValueRangeFloatFromXML( xml );
            }
            else if ( nodeName == L"height" && currentBranch != 0 && currentChild == 0 && currentLeaf != 0 )
            {
                currentLeaf->Height = getValueRangeFloatFromXML( xml );
            }
            else if ( nodeName == L"scale" && currentBranch != 0 && currentChild == 0 && currentLeaf != 0 )
            {
            ...
            else if ( nodeName == L"red" && currentBranch != 0 && currentChild == 0 && currentLeaf != 0 )
            {
                currentLeaf->Red = getValueRangeIntFromXML( xml );
            }
            else if ( nodeName == L"green" && currentBranch != 0 && currentChild == 0 && currentLeaf != 0 )
            {
                currentLeaf->Green = getValueRangeIntFromXML( xml );
            }
            else if ( nodeName == L"blue" && currentBranch != 0 && currentChild == 0 && currentLeaf != 0 )
            {
                currentLeaf->Blue = getValueRangeIntFromXML( xml );
            }
            else if ( nodeName == L"alpha" && currentBranch != 0 && currentChild == 0 && currentLeaf != 0 )
            {
        ...
        case io::EXN_ELEMENT_END:
            ...
            else if ( nodeName == L"child" && currentBranch != 0 && currentChild != 0 )
            {
                currentBranch->Children.push_back( *currentChild );
                delete currentChild;
                currentChild = 0;
            }
            else if ( nodeName == L"leaf" && currentBranch != 0 && currentLeaf != 0 )
            {
